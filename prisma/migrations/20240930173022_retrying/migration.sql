...
CREATE TABLE "Message" (
    ...
    "readByAll" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "Membership_userId_groupChatId_key" ON "Membership"("userId", "groupChatId");
...
-- AddForeignKey
ALTER TABLE "Membership" ADD CONSTRAINT "Membership_groupChatId_fkey" FOREIGN KEY ("groupChatId") REFERENCES "GroupChat"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
